...
Drone Control Radius: Standard Comms = 500m; Neural Link = Line of Sight.`,
    ...
    note: `Destroyed synthetic drones can be repaired via Mechanics CR 15; dead biological beasts require revivification or cloning.`
  },
  {
...
- **Black Market / Contraband:** +100% markup; requires Streetwise / Underworld check vs Law Level DC.`,
    mechanic: `Item Value = 10 * 4^(CR / 5) Credits
