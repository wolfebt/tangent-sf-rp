...
const TACTICAL_PACES = [
  ...
  { id: 'movement-running', name: 'Ground: Running Pace (4x Base)', category: 'species_movement', classification: 'pace', target_mode: 'Ground', multiplier: 4.0, speed: 120, bp: 0, description: 'Fast running pace (4x Base Walk) requiring Athletics check (CR 10+) each minute.' },
  { id: 'movement-sprinting', name: 'Ground: Sprinting Pace (6x Base)', category: 'species_movement', classification: 'pace', target_mode: 'Ground', multiplier: 6.0, speed: 180, bp: 0, description: 'Maximum land sprint (6x Base Walk) requiring demanding Athletics check (CR 15+) each minute.' },
  ...
  { id: 'movement-surge', name: 'Flying: Surge / Soar Pace (4x Fly)', category: 'species_movement', classification: 'pace', target_mode: 'Flying', multiplier: 4.0, speed: 240, bp: 0, description: 'Maximum aerial sprint (4x Fly) requiring Acrobatics check (CR 10+) each minute.' },
  ...
  { id: 'movement-stroke', name: 'Swimming: Stroke Pace (4x Swim)', category: 'species_movement', classification: 'pace', target_mode: 'Swimming', multiplier: 4.0, speed: 120, bp: 0, description: 'Maximum aquatic power-stroke sprint (4x Swim) requiring Athletics CR 15+.' },
