...
export const BASIC_SPECIES_TRAITS = [
  {
...
export const ADVANCED_SPECIES_TRAITS = [
  {
...
export const ELITE_SPECIES_TRAITS = [
  {
...
const ALL_SPECIES_TRAITS = [
  ...BASIC_SPECIES_TRAITS,
  ...ADVANCED_SPECIES_TRAITS,
  ...ELITE_SPECIES_TRAITS
];

// Write Markdown files to src/data/omnicortex/traits/
ALL_SPECIES_TRAITS.forEach(trait => {
...
category: traits
trait_type: Species Trait
trait_tier: ${trait.trait_tier}
classification: ${trait.classification}
type: ${trait.type}
description: "${trait.desc.replace(/"/g, '\\"')}"
costs:
  bp: ${trait.bp}
  credits: 0
  nodes: 0
...
**Category**: Species Traits (${trait.trait_tier})  
**Cost**: ${trait.bp} BP  
**Type**: ${trait.type}${trait.is_ranked ? ' (Ranked)' : ''}  
...
// Generate src/data/speciesTraitsData.js
const speciesTraitsJsContent = `/**
 ...
 * Total Basic Traits: ${BASIC_SPECIES_TRAITS.length}
 * Total Advanced Traits: ${ADVANCED_SPECIES_TRAITS.length}
 * Total Elite Traits: ${ELITE_SPECIES_TRAITS.length}
 * Total Traits: ${ALL_SPECIES_TRAITS.length}
 */

export const SPECIES_TRAITS_BASIC = ${JSON.stringify(BASIC_SPECIES_TRAITS, null, 2)};

export const SPECIES_TRAITS_ADVANCED = ${JSON.stringify(ADVANCED_SPECIES_TRAITS, null, 2)};

export const SPECIES_TRAITS_ELITE = ${JSON.stringify(ELITE_SPECIES_TRAITS, null, 2)};
...
fs.writeFileSync(traitsDataJsPath, speciesTraitsJsContent, 'utf8');
console.log('Generated speciesTraitsData.js with', ALL_SPECIES_TRAITS.length, 'total traits (Basic + Advanced + Elite).');
console.log('All species traits synchronized successfully.');
