export const combatArticles = [
  ...
  },
  {
    ...
    mechanic: 'DeathSaves: StabilityPoints = CON + 5 (Suffers 1 point damage per round while at 0 HP)\nMassiveDamageDeath: LeftoverDamage >= MaxHP',
    guide: 'When at 0 HP, track Stability Points. Allies should apply first aid immediately.',
