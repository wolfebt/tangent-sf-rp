...
export const DEFAULT_SPECIES_DISADVANTAGES = [
  ...
  },
  {
    ...
    "mechanics": "### Tiers & Effects\n- **Minor (3 BP)**: Mood swings. `-2` penalty to social interactions when under stress.\n- **Moderate (6 BP)**: Outbursts or deep withdrawal. Make **Will Save (CR 15)** under duress or become *Stunned* for 1 round.\n- **Major (9 BP)**: Debilitating hysteria or catatonia. Make **Will Save (CR 20)** at start of any round where damage is taken to act normally.\n- **Severe (12 BP)**: Crippling instability. Permanent **-2 to Will saves**. Must pass **Will Save (CR 18)** at start of each combat turn or become *Panicked*, *Paralyzed*, or *Staggered*.",
    "mechanic": "### Tiers & Effects\n- **Minor (3 BP)**: Mood swings. `-2` penalty to social interactions when under stress.\n- **Moderate (6 BP)**: Outbursts or deep withdrawal. Make **Will Save (CR 15)** under duress or become *Stunned* for 1 round.\n- **Major (9 BP)**: Debilitating hysteria or catatonia. Make **Will Save (CR 20)** at start of any round where damage is taken to act normally.\n- **Severe (12 BP)**: Crippling instability. Permanent **-2 to Will saves**. Must pass **Will Save (CR 18)** at start of each combat turn or become *Panicked*, *Paralyzed*, or *Staggered*.",
    "rules": "Hindrance: Grants 0 CP refund upon selection.",
    "modifiers": [
      {
  ...
  },
  {
    ...
    "mechanics": "### Tiers & Effects\n- **Minor (3 BP)**: Disgust & Prejudice. `-2` to all Social checks with target group.\n- **Moderate (6 BP)**: Loathing. Must pass a **Will Save (CR 15)** to assist, heal, or cooperate with them.\n- **Major (9 BP)**: Violent animosity. Must pass a **Will Save (CR 18)** *not* to attack or sabotage them on sight.",
    "mechanic": "### Tiers & Effects\n- **Minor (3 BP)**: Disgust & Prejudice. `-2` to all Social checks with target group.\n- **Moderate (6 BP)**: Loathing. Must pass a **Will Save (CR 15)** to assist, heal, or cooperate with them.\n- **Major (9 BP)**: Violent animosity. Must pass a **Will Save (CR 18)** *not* to attack or sabotage them on sight.",
    "rules": "Hindrance: Grants 0 CP refund upon selection.",
    "modifiers": [
      {
