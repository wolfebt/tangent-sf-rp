...
export const DEFAULT_FEATURES = [
  ...
  },
  {
    ...
    "mechanic": "If you have time to prepare for an encounter (minimum 1 hour), make a **Logic Check**. For every point your result exceeds CR 10, you create a **Bonus Pool**.",
    "rules": "103",
    "special_rules": "103",
    "body": "# Master Plan\n\n**Category**: General Features  \n**Cost**: 3 BP (2 BP if Suggested Feature, minimum 1 BP)  \n**Prerequisite**: Logic 6, Intellect 3\n\n## Description\nThe character is a tactical genius who prepares for every eventuality.\n\n## Mechanics & Benefit\nIf you have time to prepare for an encounter (minimum 1 hour), make a **Logic Check**. For every point your result exceeds CR 10, you create a **Bonus Pool**.\n\n## Special Rules\n103",
    "mechanics": "If you have time to prepare for an encounter (minimum 1 hour), make a **Logic Check**. For every point your result exceeds CR 10, you create a **Bonus Pool**.",
    "notes": "[Rule] 103\n[Prerequisite] Logic 6, Intellect 3",
    "notesList": [
      "[Rule] 103",
      "[Prerequisite] Logic 6, Intellect 3"
  ...
  },
  {
    ...
    "mechanic": "You can voluntarily slow your heartbeat and metabolism. You consume 1/10th the oxygen and food. You can appear dead to casual inspection (Medicine check CR 20 to detect life).",
    "rules": "110",
    "special_rules": "110",
    "body": "# Trance\n\n**Category**: General Features  \n**Cost**: 3 BP (2 BP if Suggested Feature, minimum 1 BP)  \n**Prerequisite**: Wisdom 1\n\n## Description\nThe character can enter a deep meditative state to conserve energy or feign death.\n\n## Mechanics & Benefit\nYou can voluntarily slow your heartbeat and metabolism. You consume 1/10th the oxygen and food. You can appear dead to casual inspection (Medicine check CR 20 to detect life).\n\n## Special Rules\n110",
    "mechanics": "You can voluntarily slow your heartbeat and metabolism. You consume 1/10th the oxygen and food. You can appear dead to casual inspection (Medicine check CR 20 to detect life).",
    "notes": "[Rule] 110\n[Prerequisite] Wisdom 1",
    "notesList": [
      "[Rule] 110",
      "[Prerequisite] Wisdom 1"
