...
recommended_origins: ["Research","Urban","Enlightened"]
recommended_factions: ["Ascendancy (Academics)","Impyrium (Masters)","Entari Combine"]
essential_skills: ["Diplomacy","Knowledge (Academics)","Insight","Leadership"]
signature_features: ["Shared Wisdom","Mentorship"]
...
## Tactical Role
Granting bonuses to allies' learning and skill checks, tactical instruction.
