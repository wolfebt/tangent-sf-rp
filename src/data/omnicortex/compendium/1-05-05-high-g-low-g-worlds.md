...
```
High-G Traits: Dense Bone Mass, Heavy Lifter, Standard G Speed (+5 ft)
Low-G Traits: Graceful Leaper (Double Jump), Kinetic Drift, Spatial Coordination
```

## Gameplay Instructions
Select based on your character's physiological background.

## Designer Notes
Gravitational adaptations represent deep cellular acclimation to extreme worlds.
