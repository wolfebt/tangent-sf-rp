...
# 1.07.03 Mental Skills: Vocations & Trades
...
- **Crafting Check:** `2d10 + Vocation Rank + Associated Mod vs Design DC`
...
Use vocation skills during campaign downtime to manufacture customized gear, repair starships, and earn trade income.

## Designer Notes
Crafting masterwork gear with special weapon traits requires Expert rank (Rank 11+) in the relevant vocation.
