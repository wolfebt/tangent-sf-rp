...
# 1.07.05 Combat Skills (Archaic, Modern, Advanced)
...
Investing in Combat Skills increases both your base attack bonus and the number of actions you can execute per turn.

## Designer Notes
Advanced weapons (TL 4+) inflict exotic damage types that bypass standard kinetic armor DR.
