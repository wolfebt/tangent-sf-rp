...
# 4.10 Meta-Tech, Focus Relics & Resonance Engineering Matrix
...
```
Psi-Amp Bonus: +2 to Attune and Potency checks.
Resonance Overload: Casting on a natural 1 forces a DC 15 Fortitude save to avoid equipment burnout.
```

## Gameplay Instructions
Equip focus relics in weapon or armor sockets to enhance invocation potency.

## Designer Notes
Meta-Tech requires regular calibration during rest cycles.
