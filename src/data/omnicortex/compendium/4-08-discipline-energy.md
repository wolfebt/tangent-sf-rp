...
```
ElementalDamage = 1d6 per Stage + Invocation Level
ForceDamage = 1d8 per Stage + Invocation Level (Specific Exception)
```

## Gameplay Instructions
Energy adepts provide high-intensity direct fire, barrier protection, and battlefield crowd control.

## Designer Notes
Thermal energy ignites flammable atmospheric gases and rapidly boils liquid oxygen reserves.
