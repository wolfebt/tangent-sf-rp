...
# 3.00.10 Zero-G & Environmental Hazards
...
```
Zero-G Recoil: -2 Attack & 5ft pushback without mag-boots
Vacuum Damage: 2d10 per round after 1 round stun
```

## Gameplay Instructions
Enforce environmental hazard checks during space-walks, hull breaches, and alien ruin expeditions.

## Designer Notes
Environmental suits and mag-boots are mandatory standard gear for void operatives.
