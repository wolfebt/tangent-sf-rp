...
# 1.08.05 Technologist & Augmentation Features
...
```
Cyber Tolerance: +2 Cybernetic Slots per stage
Drone Master: 3 Active Combat Drones simultaneously
```

## Gameplay Instructions
Essential for cyber-operatives, engineers, droid commanders, and starship pilots.

## Designer Notes
Cybernetic installations require surgery and recovery time unless installed during character generation.
