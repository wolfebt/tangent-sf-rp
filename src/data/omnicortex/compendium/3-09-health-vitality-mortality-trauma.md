...
order: 9
---
# 3.09 Health, Vitality, Mortality & Trauma (0 HP Rules)
...
2. The character begins **Bleeding Out** and suffers 1 point of **Stability Damage** at the start of each turn.
3. **Stability Threshold:** Total Stability Points = $\text{Constitution Score} + 5$.
4. If Stability Points reach 0, the character **Perishes**.
