...
# 1.04.10.04 Generic Templates: Faith & Mysticism
...
```
Template Skill Points: 20 SP
Template Base ML: ML 3 to ML 5
```

## Gameplay Instructions
Deploy for mystery investigations, cult confrontations, and cosmic horror encounters.

## Designer Notes
Cultists provide high-stakes narrative tension and eldritch metaphysical challenges.
