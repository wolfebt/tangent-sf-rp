...
# 1.03.02 Species Design & Morphological Point-Buy Matrix
...
```
Total Species CP = Attribute CP + Trait CP + Movement CP + Defense CP - Disadvantage CP - Stigma CP.
```

## Gameplay Instructions
Use this matrix when designing custom alien races for homebrew star systems.

## Designer Notes
Ensure that natural DR does not exceed DR 6 for standard Medium starting species.
