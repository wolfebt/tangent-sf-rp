...
```
1 AP = 1 BP for Character Folio Advancements
MaxSingleStatIncrease_PerAward = +1 Rank
```

## Gameplay Instructions
Spend AP between gaming sessions to advance your Persona Folio capabilities.

## Designer Notes
Architects should distribute AP at the end of each session or chapter downtime.
