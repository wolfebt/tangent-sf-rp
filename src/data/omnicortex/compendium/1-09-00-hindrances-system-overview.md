...
# 1.09.00 Hindrances System & BP Economy
...
```
Hindrance BP Values: Minor (+3 BP), Moderate (+6 BP), Major (+9 BP), Severe (+18 BP)
Recommended Hindrance Cap = 15 Bonus BP
```

## Gameplay Instructions
Select up to 15 BP of Hindrances during Step 7 of character creation to earn bonus Build Points for attributes and features.

## Designer Notes
Hindrances should actively drive roleplay and create dramatic challenges during sessions.
