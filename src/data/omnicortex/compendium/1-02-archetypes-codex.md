...
# 1.02 Archetypes & Modular Roles Master Codex
...
```
Archetype Base Array: +3 Primary Attribute, +2 Secondary Attribute, +1 Tertiary Attribute.
Pre-allocated Skill Package: 10 Ranks in Essential Skills.
```

## Gameplay Instructions
Select an Archetype in the Folio builder to instantly populate your recommended attributes and skill allocations.

## Designer Notes
Archetypes can be customized freely by swapping secondary skills.
