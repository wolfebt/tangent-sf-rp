...
# 3.00.08 Canonical Status Effects & Conditions Matrix
...
```
Bleeding: 1d4 dmg/turn ignores DR (Medicine DC 10)
...
Track conditions on the Folio and Foundry combat tracker during active skirmishes.

## Designer Notes
Prone provides +2 Defense per range category after Point Blank vs. ranged attacks.
