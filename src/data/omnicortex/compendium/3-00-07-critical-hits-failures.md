...
# 3.00.07 Critical Hits & Failure Severity Tables
...
```
Dual 10s (Nat 20): Auto-Hit, Subtotal = 30, 2x Damage Dice, 50% Armor DR Bypass
Dual 1s (Nat 2): Auto-Miss, Subtotal = -10, Weapon Jam / Fumble Check
```

## Gameplay Instructions
Roll double damage dice on critical hits. Apply fumble complications narratively.

## Designer Notes
High Ground adds +2 to the critical hit threshold window.
