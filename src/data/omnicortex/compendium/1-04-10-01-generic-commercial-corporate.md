...
```
Template Skill Points: 20 SP (Allocated per template profile)
Template Base TL: TL 3 to TL 4
```

## Gameplay Instructions
Use these secondary templates to quickly construct corporate adversaries, neutral shipping guilds, and orbital resorts for Architect campaigns.

## Designer Notes
Generic templates allow flexible customization for secondary player backgrounds or GM factions.
