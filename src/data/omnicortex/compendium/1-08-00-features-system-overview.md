...
# 1.08.00 Features System & 3 BP Cost Structure
...
```
Standard Feature Cost = 3 BP
Recommended Feature Cost = 2 BP (1 BP Discount)
Ranked Feature Max Stages = 5 Stages (Stage limit = Skill Tier)
```

## Gameplay Instructions
Select Features during character creation or spend experience points during campaign progression.

## Designer Notes
Ranked features allow specialized characters to stack potent bonuses in their core competencies.
