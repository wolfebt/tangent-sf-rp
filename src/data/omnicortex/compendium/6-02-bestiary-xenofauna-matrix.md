...
# 6.02 Xenofauna & Alien Beast Taxonomy Matrix
...
```
Pack Tactics: +1 to attack rolls for each allied creature within 5 ft of the target (max +5).
Camouflage: +5 bonus to Stealth checks in native planetary biome.
```

## Gameplay Instructions
Reference creature entries in the Omnicortex DBM Bestiary table when spawning random encounters.

## Designer Notes
Alien beasts do not use Credits; their salvage value comes from rare pelts, organs, and biomaterial glands.
