...
# 1.04.15 The Outworlds (Frontier Scavengers & Free League)
...
```
Faction Package: Survival +5, Piloting +4, Mechanics +4, Combat +4, Streetwise +3 = 20 SP
Bonus Feat: Scavenger Instinct / Rugged Survival at 2 BP
```

## Gameplay Instructions
Ideal for salvage operators, asteroid miners, drifters, survivalists, and rim gunners.

## Designer Notes
Outworlders recognize no imperial decree; loyalty is earned through shared survival.
