...
# 1.04.02 The Syndicate (Incorporated Planetary Syndication)
...
```
Faction Package: Computers +4, Vocation +4, Business +3, Culture +3, Deception +3, Investigation +3 = 20 SP
Bonus Feat: Cybernetic Integration / Wealth at 2 BP
```

## Gameplay Instructions
Ideal for hackers, corporate fixers, cyber-enhanced operatives, executives, and tech specialists.

## Designer Notes
The Syndicate trades with everyone but is trusted by no one.
