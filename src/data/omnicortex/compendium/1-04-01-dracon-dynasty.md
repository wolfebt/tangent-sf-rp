...
# 1.04.01 Dracon Dynasty (Feudal Monarchy / Dragon-Knights)
...
```
Faction Package: Combat +4, History +4, Diplomacy +3, Intimidate +3, Tactics +3, Pilot +3 = 20 SP
Bonus Feat: Status (Knight/Noble) at 2 BP (1 BP Discount)
```

## Gameplay Instructions
Ideal for noble warriors, battle-mages, honorbound dragoons, and diplomatic envoys.

## Designer Notes
The Dynasty views the Coalition as anarchic and the Syndicate as vulgar merchants.
