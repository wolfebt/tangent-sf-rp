...
# 2.02 Weaponry Catalog, Damage Classifications & Sockets
...
```
Damage Roll: Base Weapon Dice (e.g. 2d8) + Skill Rank Modifier + Critical Burst.
Armor Piercing (AP X): Ignores X points of target Armor DR before applying damage to Vitality.
```

## Gameplay Instructions
Equip weapons in the Folio inventory to automatically calculate strike and damage bonuses.

## Designer Notes
Reloading a weapon takes 1 Standard Action.
