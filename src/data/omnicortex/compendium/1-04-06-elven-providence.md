...
# 1.04.06 Elven Providence (Ancient Sages & Star-Weavers)
...
```
Faction Package: Attune +4, Culture +4, Combat +4, History +3, Diplomacy +3, Nature +2 = 20 SP
Bonus Feat: Ethereal Grace / Ancient Lineage at 2 BP
```

## Gameplay Instructions
Ideal for star-singers, magitech archers, noble diplomats, and ancient lorekeepers.

## Designer Notes
The Providence looks upon younger human factions with patronizing patience.
