...
```
DisbeliefDC = 10 + AttuneRank + KeyAbilityMod vs Alertness/Will
DeceptionPotency = 1d6 per Stage achieved with check
```

## Gameplay Instructions
Use Illusion for covert infiltration, electronic deception, diverting enemy sniper fire, and cloaking squad vehicles.

## Designer Notes
Tactile physical contact with an illusion permits an immediate Disbelief saving throw with Advantage.
