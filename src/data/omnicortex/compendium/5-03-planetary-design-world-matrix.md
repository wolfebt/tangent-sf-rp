...
# 5.03 Planetary Design & Universal World Profile (UWP) Matrix
...
```
Universal World Profile Syntax: [Starport]-[Size]-[Atmosphere]-[Hydro]-[Population]-[Gov]-[Law]-[Tech]-[Meta]
Example: B-7-4-5-8-5-4-3-1 (Class B Starport, Standard Atmosphere, 50% Water, 100 Million Pop, TL3, ML1)
```

## Gameplay Instructions
Roll or select codes for each metric when creating new star systems for campaigns.

## Designer Notes
Planetary Tech Level dictates local equipment availability and repair part costs.
