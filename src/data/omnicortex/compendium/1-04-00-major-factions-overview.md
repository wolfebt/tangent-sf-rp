...
# 1.04.00 Major Factions Overview & Alignment Matrix
...
```
FactionSkillPoints = 20
FactionFeatureDiscount = 1 BP per recommended feature (Min 1 BP)
```

## Gameplay Instructions
Choose one Major Faction during Step 4 of character creation. Allocate your 20 Faction Skill Points and select 2 Faction Features.

## Designer Notes
Major Factions are the primary choice for player characters. Generic Factions (1.04.10) serve as secondary options for custom backgrounds.
