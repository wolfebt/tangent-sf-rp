...
# 1.04.05 Auluran Clans (Nomadic Starfarers & Bio-Smiths)
...
```
Faction Package: Biology +5, Piloting +4, Bio-Tech +4, Space Survival +3, Combat +4 = 20 SP
Bonus Feat: Bio-Engineered Adaptation / Zero-G Veteran at 2 BP
```

## Gameplay Instructions
Ideal for geneticists, space pilots, living-ship engineers, and fleet defense warriors.

## Designer Notes
The Clans prize ancestral family lineage and organic technology over cold metal.
