...
# 1.07.04 Social Skills (Charm, Deception, Diplomacy, Leadership)
...
Use social skills to avoid unnecessary bloodshed, recruit allies, and manipulate enemies.

## Designer Notes
Social checks are heavily influenced by the target's faction loyalty and current hostility level.
