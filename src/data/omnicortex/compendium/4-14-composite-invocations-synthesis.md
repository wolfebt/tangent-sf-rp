...
# 4.14 Composite Invocations: The Synthesis of Disciplines
...
Train multiple disciplines to qualify for composite invocations that combine the capabilities of both spheres.

## Designer Notes
Composite Invocations count as known Invocations for both disciplines, but require both Awakened features.
