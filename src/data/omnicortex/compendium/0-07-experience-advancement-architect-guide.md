...
# 0.07 Architect Guide to Experience Awards, Pacing & Downtime
...
```
Standard Award Rate: 1-3 AP/session.
Crafting Time = Crafting_DC * 2 Hours (Reduced by 50% in a fully equipped laboratory).
```

## Gameplay Instructions
Award AP at the end of each session after players summarize their character highlights and goals.

## Designer Notes
Experience debt from dying should be tracked visibly on the character folio.
