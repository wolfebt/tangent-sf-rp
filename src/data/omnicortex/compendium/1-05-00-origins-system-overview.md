...
# 1.05.00 Origins System & Environmental Adaptation Rules
...
```
OriginSkillPoints = 20
OriginTraits = 2 (Selected from Origin Trait List)
SecondaryOrigin = Allows cross-selection of traits without extra points
```

## Gameplay Instructions
Select one Origin during Step 5 of character creation. Allocate 20 SP among listed skills and choose 2 Traits.

## Designer Notes
Origins ground characters in their home environment and explain their unique physical or survival advantages.
