...
# 1.02.02 Modular Persona Assembly & Rapid Adversary Generator
...
```
Quick Stat Formula: Health = 30 + (Sta * 5); Attack Bonus = Attribute + Skill Rank; Defense = 10 + Agility + Armor.
```

## Gameplay Instructions
Use these modular blocks to instantly spin up encounters during live tabletop sessions.

## Designer Notes
All modular archetypes adhere to the standard 150 BP math budget.
