...
# 3.00.02 Initiative, Surprise & Active Defenses
...
```
Initiative = 2d10 + ReflexSave + AgilityMod
Surprise Attack: Attacker at -5 to hit vs NO Target Defense; Damage rolled with Advantage
```

## Gameplay Instructions
Roll 2d10 initiative once at encounter start. Ambushes deny defender reaction defense.

## Designer Notes
Danger Sense prevents surprise and grants advantage on awareness tests.
