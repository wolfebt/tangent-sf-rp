...
# 1.04.07 Kovian Tribunal (Technocratic Arbiters & Lawbringers)
...
```
Faction Package: Investigation +5, Law +4, Combat +4, Alertness +4, Intimidate +3 = 20 SP
Bonus Feat: Incorruptible Will / Precision Strike at 2 BP
```

## Gameplay Instructions
Ideal for galactic marshals, forensic investigators, bounty arbiters, and tactical judges.

## Designer Notes
The Tribunal enforces laws strictly according to written statutes without personal bias.
