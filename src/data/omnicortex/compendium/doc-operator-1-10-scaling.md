---
id: "doc-operator-1-10-scaling"
name: "1.10 SCALING — SCALING"
...
tl: 3
ml: 0
tags: ["operator","core-rules","1.10 scaling","mechanics"]
...
This multiplier applies to Meta-Tech and Invocations as well when generated by a chassis of this size (e.g., a Fireball from a Huge Mech deals x5 Damage, 5d6 damage expanded to 25d6 as well as Range and Area \- Save CRs remain as well as other effect values that would not be altered by size).
...
```
See full canonical text in 1.10 SCALING.md
```

## Gameplay Instructions
Refer to 1.10 SCALING.md in the game rules library for complete architectural tables and system parameters.

## Designer Notes
Canonical Tangent SF RP rulebook reference from 1.10 SCALING.md.
