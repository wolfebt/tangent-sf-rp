...
# 1.05.03 Asteroid Belts & Deep Space Enclaves
...
```
Origin Skills: Piloting, Technology, Space Survival, Astrogation, Geology, Zero-G Athletics (20 SP)
Origin Traits: Choose 2 (Zero-G Native, Vacuum Instincts, Astrogation, Life Support, Radiation Hardened, Mineral Eye)
```

## Gameplay Instructions
Ideal for asteroid miners, void pilots, salvage engineers, and deep space scouts.

## Designer Notes
Belters often feel uncomfortable under open, boundless planetary skies.
