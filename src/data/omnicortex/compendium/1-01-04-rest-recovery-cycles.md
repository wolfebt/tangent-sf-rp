...
# 1.01.04 Rest Cycles, Respite, Sleep & Healing
...
```
Respite: d10 + Stamina Vitality
Light Rest (2h): 100% Vitality
Full Rest (8h): 100% Vitality + (Stamina + 5) Health
```

## Gameplay Instructions
Plan tactical respites between security checkpoints and dungeon corridors.

## Designer Notes
Severe trauma or fractured limbs require surgical downtime and cannot be healed by simple rests.
