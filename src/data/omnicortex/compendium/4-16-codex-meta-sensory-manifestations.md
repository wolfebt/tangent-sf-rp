...
# 4.16 Codex: Meta-Sensory Manifestations & Colorations
...
```
SensoryManifestation = ArchetypeTradition + RootDisciplineSignature
```

## Gameplay Instructions
Describe the visual, audio, and tactile texture of invocations based on the caster's cultural origin and discipline.

## Designer Notes
Sensory signatures allow observers with Alertness or Attune to identify the school and source of an incoming spell.
