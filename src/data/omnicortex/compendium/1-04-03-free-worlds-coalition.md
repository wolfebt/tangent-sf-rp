...
```
Faction Package: Piloting +4, Survival +4, Technology +3, Firearms +3, Streetwise +3, Alertness +3 = 20 SP
Bonus Feat: Jack of All Trades / Independent Grit at 2 BP
```

## Gameplay Instructions
Ideal for smugglers, frontier marshals, blockade runners, freedom fighters, and scrappy star pilots.

## Designer Notes
Coalition characters value personal freedom above rigid hierarchy.
