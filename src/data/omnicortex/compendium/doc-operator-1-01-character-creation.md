...
updatedAt: "2026-09-14T19:51:39.808Z"
costs:
  bp: 0
  credits: 0
  nodes: 0
...
Two characters engage in a heated debate, each trying to persuade the other to their point of view. The GM calls for an Opposed Challenge using Charisma based Persuasion checks. Both characters roll 2d10 and add their Etiquette. The character with the higher total wins the debate, swaying the other to their side.
...
A character with a Strength score of \+3 attempts to bend a metal bar. The GM sets the CR for the Might check at 15\. The character's base score for Might checks is 8 (2 \+ 2 x 3). If there are no modifiers, the character needs to roll a 7 or higher on 2d10 to succeed.
...
A character with an Agility score of \+3 attempts to avoid a fiery blast from an explosion. The GM sets the CR for the Reflex check at 15\. The character's base score for Reflex checks is 8 (2 \+ 2 x 3). If there are no modifiers, the character needs to roll a 7 or higher on 2d10 to successfully dive out of harm's way.
...
A character with an Intellect score of \+4 attempts to solve a riddle that guards a hidden treasure. The GM sets the CR for the Reason check at 20\. The character's base score for Reason checks is 10 (2 \+ 2 x 4). If there are no modifiers, the character needs to roll a 10 or higher on 2d10 to successfully solve the riddle.&nbsp;
...
A character with a Wisdom of \+5 is targeted by a psychic enemy who tries to implant a suggestion in their mind. The GM calls for a Willpower check to resist the psychic attack. The GM sets the CR for the check at 15\. The character's base score for Willpower checks is 12 (2 \+ 2 x 5). If there are no modifiers, the character needs to roll a 3 or higher on 2d10 to successfully resist the implanted suggestion.&nbsp;
