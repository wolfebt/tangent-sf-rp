---
id: "doc-operator-3-00-combat"
name: "3.00 COMBAT — COMBAT"
...
updatedAt: "2026-09-15T07:48:15.261Z"
costs:
  bp: 0
  credits: 0
  nodes: 0
...
**In the game, combat employs a 2d10 dice system, which adds an element of randomness and uncertainty to each encounter. The outcome of actions is determined by rolling a twenty-sided die (2d10) and adding relevant modifiers. These modifiers take into account character skills, abilities, and various situational factors.**
...
*The attacker rolls a 2d10, adds their relevant Ability Score modifier and any applicable Skill modifiers, and compares the total to the target's Defense. If the total equals or exceeds the target's Defense, the attack hits.*
...
```
See full canonical text in 3.00 COMBAT.md
```

## Gameplay Instructions
Refer to 3.00 COMBAT.md in the game rules library for complete architectural tables and system parameters.

## Designer Notes
Canonical Tangent SF RP rulebook reference from 3.00 COMBAT.md.
