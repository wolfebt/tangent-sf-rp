...
```
Telekinetic Throw: 1 Essence -> 2d8 Kinetic (Range 60ft)
Telekinetic Crush: 3 Essence -> 4d10 Crushing Damage (Might DC)
Telekinetic Storm: 4 Essence -> 6d10 Damage in 40ft Radius
```

## Gameplay Instructions
Matter adepts provide massive physical battlefield control, barricades, and object manipulation.

## Designer Notes
Telekinesis uses your Intellect or Wisdom modifier for grapple checks and throwing accuracy.
