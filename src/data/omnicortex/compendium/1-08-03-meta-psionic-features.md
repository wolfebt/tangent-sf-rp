...
```
Deep Attunement: +4 Max Essence per rank
Overchannel: 1 Essence Point = 2 HP sacrificed
```

## Gameplay Instructions
Crucial for Adepts, Arcanists, and Psions looking to cast multiple invocations in high-stakes combat.

## Designer Notes
Overchanneling is a double-edged sword: powerful in an emergency, but lethal if mismanaged.
