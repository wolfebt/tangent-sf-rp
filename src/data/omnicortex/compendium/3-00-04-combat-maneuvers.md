...
# 3.00.04 Combat Maneuvers & EDGE Tactical Modifiers
...
```
Aiming: +2 Strike/rnd (up to 1/2 Skill Rank)
Flanking: +2 to Hit
...
Declare tactical maneuvers or stance adjustments at the start of your movement or attack sequence.

## Designer Notes
Close In and Withdraw prevent provoking defensive Advancing/Retreating counter-attacks.
