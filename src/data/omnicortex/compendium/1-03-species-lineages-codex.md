...
# 1.03 Species Lineages & Morphological Taxonomy Codex
...
```
Species Cost Formula: Total CP = Attribute Mods + Innate Traits + Movement Modes - Disadvantages - Stigma.
Base Pace: 30 ft (Medium), adjusted by Size and Movement traits.
```

## Gameplay Instructions
Review the Species table in DBM to inspect detailed stats, CP values, and lore profiles.

## Designer Notes
All species adhere to standard size categories from Fine to Colossal.
