...
# 1.08.02 Combat Features & Weapon Specializations
...
```
Weapon Spec: +2 Attack / +2 Damage with chosen weapon group
Dual Wielding: Primary Attack + Off-hand Attack (penalty reduced by feat)
```

## Gameplay Instructions
Stack Combat Features with high Combat Skill ranks to dominate the tactical action economy.

## Designer Notes
Deflect allows skilled cyber-samurai and energy blade masters to protect teammates from sniper fire.
