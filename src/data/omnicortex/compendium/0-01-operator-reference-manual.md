...
# 0.01 OPERATOR Reference Manual (Player Character & Folio Guide)
...
1. Check your Persona Folio for current HP, Armor DR, and Essence Pool.
...
## Designer Notes
Operators should balance offensive actions with defensive reserves, as reactive defenses suffer cumulative penalties.
