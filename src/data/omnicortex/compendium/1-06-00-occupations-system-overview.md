...
# 1.06.00 Occupations System & Career Paths
...
```
ProfessionalSkillPoints = 20
RecommendedFeatureDiscount = 1 BP discount (Cost: 2 BP)
OccupationalTraits = Choose 2
```

## Gameplay Instructions
Choose your Occupation during Step 6 of character creation. Allocate your 20 SP and select 2 Traits.

## Designer Notes
Occupations define what your character does for a living and their core competency in the party.
