...
# 1.04.13 The Entari Combine (Hydro-Mineral Technocracy)
...
```
Faction Package: Technology +4, Streetwise +4, Combat +4, Survival +4, Business +4 = 20 SP
Bonus Feat: Industrial Connections / Deep Diver at 2 BP
```

## Gameplay Instructions
Ideal for industrial scicon operatives, heavy riggers, ore barons, and corporate mercenaries.

## Designer Notes
The Combine operates with aggressive economic mercantilism and strict extraction quotas.
