...
typical_archetypes: ["The Drone","The Synapse Node","The Infiltrator","The Siege-Breaker","The Queen"]
skill_package: ["Awareness (+5)","Athletics (+4)","Combat (Melee) (+4)","Survival (+4)","Stealth (+3)"]
recommended_features: ["Mind Link","Fearless","Uncanny Dodge","Wall-Crawler","Swarm Tactics (Coordinated Assist)","Echolocation","Endurance","Diehard","Natural Weapons","Scent"]
features: ["Mind Link","Fearless","Uncanny Dodge","Wall-Crawler","Swarm Tactics (Coordinated Assist)","Echolocation","Endurance","Diehard","Natural Weapons","Scent"]
