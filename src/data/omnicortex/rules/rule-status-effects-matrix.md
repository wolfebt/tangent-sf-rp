---
id: rule-status-effects-matrix
name: Master Status Effects Matrix
category: rules
description: >-
  Canonical reference matrix of all 10 combat status effects, mechanical
  penalties, and cures/removals.
costs:
  bp: 0
modifiers: []
---
# Master Status Effects Matrix
