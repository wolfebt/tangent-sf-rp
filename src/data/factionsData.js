...
export const DEFAULT_FACTIONS = [
  ...
  },
  {
    ...
    "driving_mandate": "Grow the Garden; Choke the Weeds",
    "symbol_sigil": "The Spiral Leaf",
    "capital_world": "New Home (The World-Tree)",
    "tech_level": "4",
    "meta_level": "3",
    "wealth_modifier": "+0 (Non-monetary, Resource Abundant)",
    "prominent_species": "Aulurans (Dar, Koda, Graa)",
    "typical_archetypes": [
      "The Warden",
      "The Field Medic",
      "The Beast-Handler",
  ...
  },
  {
    ...
    "name": "Cosmic Horror Faction Template",
    "category": "factions",
    "faction_type": "Generic Template",
    "archetype": "Eldritch Cults",
    "driving_mandate": "Summon or control eldritch entities, destroy all life, harness the unknown",
    "symbol_sigil": "The Mad Ones / The Doomsayers",
    "capital_world": "Variable (Dark corners of space, ancient ruins)",
    "tech_level": "3",
    "meta_level": "0",
    "wealth_modifier": "0",
    "prominent_species": "Variable (Often mutated or corrupted)",
    "typical_archetypes": [
      "The Cultist",
      "The Occultist",
      "The Doomsayer",
  ...
  },
  {
    ...
    "description": "Syndicates, cartels, and mafias operating in the shadows of galactic civilization. They are characterized by their involvement in illegal activities, accumulating wealth, power, and influence through illicit means while avoiding the gaze of official authorities",
    "costs": {
      "bp": 0,
      "credits": 0,
      "nodes": 0,
  ...
  },
  {
    ...
    "tech_level": "3",
    "meta_level": "3",
    "wealth_modifier": "+2 (Old Money / High Resources)",
    "prominent_species": "Humans, Draconic Descendants",
    "typical_archetypes": [
      "The Protector",
      "The Veteran",
      "The Legionnaire",
  ...
  },
  {
    ...
    "description": "Militant and passionate factions deeply focused on environmental preservation. They actively oppose destructive industrial activities, promoting sustainability and protecting natural habitats through direct, often violent, action",
    "costs": {
      "bp": 0,
      "credits": 0,
      "nodes": 0,
  ...
  },
  {
    ...
    "recommended_features": [
      ...
      "Uncanny Dodge",
      "Wall-Crawler",
      "Swarm Tactics (Coordinated Assist)",
      "Echolocation",
      "Endurance",
      "Diehard",
      "Natural Weapons",
  ...
  },
  {
    ...
    "driving_mandate": "Preserve the Order; Reclaim the Lost",
    "symbol_sigil": "The Star of Dominion (Heavy golden 8-Pointed Star)",
    "capital_world": "Aurelia (The Throneworld)",
    "tech_level": "4",
    "meta_level": "3",
    "wealth_modifier": "+4 (Vast inherited wealth, heavily consolidated)",
  ...
  },
  {
    ...
    "symbol_sigil": "The Hexagon (representing the Hive/Mesh)",
    "capital_world": "Premius (The Corporate Core)",
    "tech_level": "4",
    "meta_level": "2",
    "wealth_modifier": "+3 (Highly Profitable)",
    "prominent_species": "Humans (Syndicate Genotype - Sleek/Modified)",
    "typical_archetypes": [
      "The Bureaucrat",
      "The Munitions Magnate",
      "The Company Man",
  ...
  },
  {
    ...
    "driving_mandate": "Purity through Shadow",
    "symbol_sigil": "Obsidian Dagger piercing a Silver Crescent Moon",
    "capital_world": "Umbra Sector Rogue Planets",
    "tech_level": "4",
    "meta_level": "3",
    "wealth_modifier": "+2 (Hoarded ancient relics/stolen resources)",
    "prominent_species": "Nocturne Elves",
    "typical_archetypes": [
      "The Silent Blade",
      "The Ghost",
      "The Operative",
  ...
  },
  {
    ...
    "name": "Military Faction Template",
    "category": "factions",
    "faction_type": "Generic Template",
    "archetype": "Standing Armies",
    "driving_mandate": "Defend the homeland, project power, follow orders",
    "symbol_sigil": "The Grunts / The Uniforms / The Brass",
    "capital_world": "Variable (Operating out of heavily fortified military starbases or capital worlds)",
    "tech_level": "3",
    "meta_level": "0",
    "wealth_modifier": "0",
    "prominent_species": "Variable (Usually homogenous to their ruling government)",
    "typical_archetypes": [
      "The Officer",
      "The Special Forces Operative",
      "The Artillery Specialist",
      "The Combat Pilot",
    ...
    "description": "The primary, state-sponsored armed forces of a planetary system or sector, dedicated entirely to defense, conquest, and the enforcement of order. Unlike mercenaries, they fight for a flag, a cause, or a government",
    "costs": {
      "bp": 0,
      "credits": 0,
      "nodes": 0,
  ...
  {
    "id": "template-mutant",
    "name": "Mutant Faction Template",
    "category": "factions",
    "faction_type": "Generic Template",
    "archetype": "The Altered",
    "driving_mandate": "Survive persecution, find acceptance, or dominate the baselines",
    "symbol_sigil": "Mutants / Freaks / Glowing Ones",
    "capital_world": "Variable (Radioactive zones, under-cities, toxic biomes)",
    "tech_level": "2 to 3 (Often scavenged)",
    "meta_level": "0",
    "wealth_modifier": "0",
    "prominent_species": "Humans/Aliens (Heavily Mutated)",
    "typical_archetypes": [
      "The Mutant Psychic",
      "The Beast-Brute",
      "The Infiltrator",
      "The Under-City Guide",
      "The Wasteland Warlord"
    ],
    "skill_package": [
      "Survival (+5)",
      "Stealth (+4)",
  ...
  },
  {
    ...
    "name": "Post-apocalyptic Faction Template",
    "category": "factions",
    "faction_type": "Generic Template",
    "archetype": "Wasteland Survivors",
    "driving_mandate": "Rebuild, secure scarce resources, survive another day",
    "symbol_sigil": "Scrappers / Dust-Eaters / The Forgotten",
    "capital_world": "A ruined, shattered husk of a former world",
    "tech_level": "2 to 3- (Scavenged)",
    "meta_level": "0",
    "wealth_modifier": "0",
    "prominent_species": "Humans (Often bearing minor radiation mutations)",
    "typical_archetypes": [
      "The Scavenger",
      "The Road-Warrior",
      "The Wasteland Medic",
      "The Tech-Priest (Artifact worshipper)",
      "The Raider"
    ],
    "skill_package": [
      "Survival (+5)",
    ...
    "description": "Survivors of a massive planetary catastrophe (nuclear, biological, or orbital bombardment). They scrape by in irradiated ruins, relying on scavenging and brutal survival instincts. They represent a severe regression in technology and society",
    "costs": {
      "bp": 0,
      "credits": 0,
      "nodes": 0,
  ...
  },
  {
    ...
    "description": "Lawless flotillas and void corsairs raiding trade routes and controlling the black markets. They are a chaotic mix of deserters, outlaws, and thrill-seekers bound together by a loose code of honor and the promise of plunder",
    "costs": {
      "bp": 0,
      "credits": 0,
      "nodes": 0,
  ...
  },
  {
    ...
    "driving_mandate": "Unlock Human Potential; Defend the New Home",
    "symbol_sigil": "The Rising Sun (Stylized, Blue/White)",
    "capital_world": "Aurelia (The Crystal Spire)",
    "tech_level": "3",
    "meta_level": "5",
    "wealth_modifier": "+1 (Developing Post-Scarcity)",
    "prominent_species": "Humans and Human Psions (High Psionic Potential)",
    "typical_archetypes": [
      "The Company Man",
      "The Ghost",
      "The Vagabond",
  ...
  },
  {
    ...
    "driving_mandate": "Optimize; Archive; Solve the Equation",
    "symbol_sigil": "The Fractal Circle (Infinite Loop)",
    "capital_world": "Mekan Prime (The Dyson Ring)",
    "tech_level": "5",
    "meta_level": "1",
    "wealth_modifier": "+6 (Resource Optimized)",
    "prominent_species": "Mekan (Synthetic Humanoids)",
    "typical_archetypes": [
      "The Logic-Sage",
      "The Null-Vector Pilot",
      "The Fractal Diplomat",
      "The Logic-Enforcer",
      "The Net-Architect",
      "The Cyberneticist"
    ],
  ...
  },
  {
    ...
    "driving_mandate": "Autonomy; Establish a foothold; Survive another day",
    "symbol_sigil": "Graffiti tags, repurposed warning signs",
    "capital_world": "None (Decentralized)",
    "tech_level": "3",
    "meta_level": "1",
    "wealth_modifier": "-1 or -2 (Generally impoverished, heavily reliant on barter)",
    "prominent_species": "Highly diverse; all species represented",
    "typical_archetypes": [
      "The Field Medic",
      "The Veteran",
      "The Foreman",
  ...
  },
  {
    ...
    "driving_mandate": "Adapt, survive, and protect the primal ecosystem",
    "symbol_sigil": "Iron wolf's head wreathed in living roots",
    "capital_world": "Vea'Sura (The Living Heart)",
    "tech_level": "3",
    "meta_level": "3",
    "wealth_modifier": "+0 (Barter System)",
    "prominent_species": "Vajar (Wild Elves)",
    "typical_archetypes": [
      "The Warden",
      "The Veteran",
      "The Beast-Handler",
