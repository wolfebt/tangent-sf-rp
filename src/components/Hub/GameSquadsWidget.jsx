...
export const GameSquadsWidget = ({ onOpenSquadsDrawer }) => {
  ...
  return (
    <div 
      ...
      className="bg-slate-900/30 hover:bg-slate-900/80 backdrop-blur-md p-2.5 sm:p-3 rounded-xl border border-emerald-500/40 hover:border-emerald-400/90 flex flex-col justify-between relative overflow-hidden group transition-all duration-200 shadow-[0_0_15px_rgba(16,185,129,0.1)] cursor-pointer select-none"
    >
      {/* Ambient Glow */}
