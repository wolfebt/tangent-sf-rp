          ...
          <div className="flex items-center gap-2 flex-wrap">
            {onGuidedCreator && (
              <button
                ...
                className="px-3 py-1.5 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white rounded text-xs font-bold uppercase shadow transition-colors flex items-center gap-1 cursor-pointer"
              >
                <span>✨</span> Guided Creator
              </button>
            )}
            <button
              onClick={() => {
