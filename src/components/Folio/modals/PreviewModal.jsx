...
const PreviewModal = ({ isOpen, onClose, characterData }) => {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-start justify-center bg-black/85 backdrop-blur-md p-2 sm:p-4 pt-8 sm:pt-12 md:pt-14 pb-12 overflow-y-auto print:p-0 print:bg-white select-none font-sans">
