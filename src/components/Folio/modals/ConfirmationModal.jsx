...
const ConfirmationModal = ({ isOpen, onClose, onConfirm, title, message }) => {
  ...
  return (
    <div className="fixed inset-0 z-[500] flex items-start justify-center bg-black/80 backdrop-blur-md p-4 pt-10 sm:pt-14 pb-12 overflow-y-auto select-none font-sans">
