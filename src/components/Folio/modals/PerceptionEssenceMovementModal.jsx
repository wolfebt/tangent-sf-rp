...
const PerceptionEssenceMovementModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black/85 backdrop-blur-md p-2 sm:p-6 overflow-y-auto">
      <div className="bg-[#0c121e] border border-cyan-500/40 rounded-2xl max-w-5xl w-full p-4 sm:p-7 shadow-[0_0_50px_rgba(6,182,212,0.2)] text-slate-100 space-y-5 my-4 sm:my-6">
            ...
            <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 space-y-3">
              ...
              <div className="p-3 rounded-lg bg-cyan-950/40 border border-cyan-800/50 text-xs text-cyan-200">
                ...
                <div className="font-mono font-bold text-cyan-300 mt-1 bg-slate-950/80 p-2 rounded border border-cyan-700/40">
                  Result = 1d20 + Perception Base + Relevant Skill Modifiers + Circumstance Modifiers
                </div>
              </div>
            </div>
