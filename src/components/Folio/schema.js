...
export const inventoryItemSchema = z.union([
  z.object({
    ...
    tl: z.union([z.string(), z.number()]).optional(),
    description: z.string().optional(),
    notes: z.string().optional()
  }).passthrough(),
  z.string()
...
export const attackSchema = z.union([
  z.object({
    ...
    weaponId: z.union([z.string(), z.number()]).nullable().optional(),
...
export const characterSchema = z.object({
  ...
  'char-secondary-occu': z.string().optional().default(''),
  'char-origin': z.string().optional().default(''),
  'char-secondary-origin': z.string().optional().default(''),
  'char-faction': z.string().optional().default(''),
  'char-age': z.union([z.string(), z.number()]).transform(v => String(v ?? '')).optional().default(''),
  'char-gender': z.string().optional().default(''),
  'char-height': z.union([z.string(), z.number()]).transform(v => String(v ?? '')).optional().default(''),
  'char-weight': z.union([z.string(), z.number()]).transform(v => String(v ?? '')).optional().default(''),
