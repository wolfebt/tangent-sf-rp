...
export const UniversalCatalogModal = ({
  ...
  // ⚡ Bolt: Using useDeferredValue for searchQuery to prevent UI stutter when filtering large catalogs.
  ...
  const processedItems = useMemo(() => {
    ...
    return list;
  }, [allRawItems, deferredSearchQuery, activeCategoryFilter, sortOption, filterCategory, filterCategoryExclude, canonicalColKey, characterData]);
