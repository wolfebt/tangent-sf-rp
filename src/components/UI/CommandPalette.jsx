...
export const CommandPalette = ({ isOpen, onClose, onDiceRolled }) => {
  ...
  const searchResults = useMemo(() => {
    ...
    const defaultNav = [
      ...
      { id: 'nav_ade', title: 'Go to ADE Studio', subtitle: 'Adventure Development Environment & Scenarios', icon: <Layers size={16} className="text-purple-400" />, action: () => { navigate('/foundry'); onClose(); } },
      { id: 'nav_story', title: 'Go to Story Weaver', subtitle: 'Scenario Trees & Campaign Arcs', icon: <BookOpen size={16} className="text-purple-400" />, action: () => { navigate('/foundry/story'); onClose(); } },
      { id: 'nav_guide_story', title: 'User Guide: ADE Studio', subtitle: 'Adventure Development, Scenarios, AIME Studio, Export', icon: <BookOpen size={16} className="text-purple-400" />, action: () => { window.dispatchEvent(new CustomEvent('open-user-guide', { detail: { tab: 'story' } })); onClose(); } },
      ...
      { id: 'nav_stage', title: 'Go to THE STAGE VTT', subtitle: 'Tactical Grid, Line-of-Sight & Live Combat', icon: <Tv2 size={16} className="text-amber-400" />, action: () => { navigate('/stage'); onClose(); } },
