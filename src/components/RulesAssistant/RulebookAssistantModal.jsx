...
export default function RulebookAssistantModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl max-h-[90vh] bg-[#0c1018] border-2 border-indigo-500/70 rounded-2xl shadow-[0_0_45px_rgba(99,102,241,0.3)] flex flex-col overflow-hidden text-slate-100 font-sans">
