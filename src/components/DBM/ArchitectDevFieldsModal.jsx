...
export const ArchitectDevFieldsModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[250] flex items-start justify-center bg-black/85 backdrop-blur-md p-2 sm:p-4 md:p-6 pt-6 sm:pt-10 md:pt-12 pb-8 overflow-y-auto select-none font-sans">
      <div className="bg-[#090d16] border border-amber-500/40 rounded-2xl w-[96vw] max-w-7xl max-h-[96vh] sm:max-h-[96dvh] flex flex-col shadow-[0_0_50px_rgba(245,158,11,0.15)] overflow-hidden">
