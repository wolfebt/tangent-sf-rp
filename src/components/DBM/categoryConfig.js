export const categoryConfig = {
    ...
    factions: {
        ...
        fields: {
            ...
            tl: { type: 'number', label: 'Tech Level' },
            wealth_modifier: { type: 'number', label: 'Wealth Modifier' },
    ...
    planetary_design: {
        ...
        viewType: 'table',
        directory_columns: ['name', 'starClass', 'orbitalZone', 'size', 'atmosphere', 'population'],
        fields: {
            ...
            techLevel: { type: 'number', label: 'Tech Level (0-5)' },
            metaLevel: { type: 'number', label: 'Metafocus Level (0-6)' },
    ...
    technology: {
        label: 'TECHNOLOGY',
        viewType: 'table',
        directory_columns: ['name', 'tl', 'craft_dc'],
        fields: {
            name: { type: 'text', required: true, label: 'Technology Profile Designation' },
            tl: { type: 'number', label: 'Tech Level (TL 0-5)' },
    ...
    invocations: {
        ...
        fields: {
            ...
            tech_level: { type: 'select', label: 'Tech Level', options: [0, 1, 2, 3, 4, 5] },
            meta_level: { type: 'select', label: 'Meta Level', options: [0, 1, 2, 3, 4, 5] },
            action_cost: { type: 'text', label: 'Action Cost' },
            cast_time: { type: 'text', label: 'Cast Time' },
            duration: { type: 'text', label: 'Duration' },
            cost: { type: 'text', label: 'Strain / Focus Cost' },
            note: { type: 'textarea' }
        }
    },
    special_abilities: {
    ...
    augmentations: {
        label: 'AUGMENTATIONS',
        viewType: 'table',
        directory_columns: ['name', 'type', 'tech_level', 'nodes', 'bp_cost', 'cost', 'design_dc'],
        fields: {
            ...
            nodes: { type: 'number', label: 'Node Cost' },
            sockets: { type: 'number', label: 'Socket Cost / Provided' },
            bp_cost: { type: 'number', label: 'Build Point (BP) Cost' },
    ...
    gear: {
        ...
        directory_columns: ['name', 'category', 'size', 'tl', 'ml', 'cost', 'craft_dc'],
        fields: {
            ...
            tl: { type: 'number', label: 'Tech Level (TL)' },
            ml: { type: 'number', label: 'Meta Level (ML)' },
            cost: { type: 'number', label: 'Credit Cost' },
            weight: { type: 'number', label: 'Weight (kg)' },
            sockets: { type: 'number', label: 'Total Sockets' },
            sp: { type: 'number', label: 'Structure Points (SP)' },
            dr: { type: 'number', label: 'Damage Resist (DR)' },
            ...
            sockets_used: { type: 'number', label: 'Sockets Used' },
            scale_tier: { type: 'select', options: ['Personal', 'Vehicle', 'Strategic'], label: 'Scale Tier' },
            daily_charges: { type: 'number', label: 'Daily Charges' },
            passive_mods: { type: 'multiselect', source: 'modifier', manageable: true, label: 'Passive Enhancements' },
            description: { type: 'textarea' },
    ...
    weaponry: {
        ...
        fields: {
            ...
            critical: { type: 'text', label: 'Critical' },
            ...
            sockets: { type: 'number', label: 'Sockets' },
            weapon_downgrades: { type: 'multiselect', source: 'disadvantages', manageable: true, label: 'Weapon Downgrades' },
            faction_skin: { type: 'select', source: 'factions', manageable: true },
            modules: { type: 'multiselect', source: 'component', manageable: true },
            design: { type: 'multiselect', source: 'design', manageable: true },
    ...
    armoring: {
        ...
        fields: {
            ...
            faction_skin: { type: 'select', source: 'factions', manageable: true },
            downgrades: { type: 'multiselect', source: 'disadvantages', manageable: true },
    ...
    mecha: {
        ...
        viewType: 'table',
        parent: 'personal_property',
        directory_columns: ['name', 'size', 'frame', 'tl', 'cost', 'craft_dc'],
        fields: {
            ...
            sp: { type: 'number', label: 'Structure Points (SP)' },
            dr: { type: 'number', label: 'Damage Resist (DR)' },
            mounts: { type: 'number', label: 'Total Mounts' },
            ...
            installed_modules: { type: 'multiselect', source: 'component', manageable: true, label: 'Installed Modules' },
            components: { type: 'multiselect', source: 'component', manageable: true, label: 'Core Components' },
    ...
    architecture: {
        ...
        viewType: 'table',
        parent: 'personal_property',
        directory_columns: ['name', 'style', 'footprint', 'tl', 'cost', 'sp', 'design_dc'],
        fields: {
            ...
            sp: { type: 'number', label: 'Structure Points (SP)' },
            dr: { type: 'number', label: 'Damage Resist (DR)' },
            modules: { type: 'number', label: 'Total Modules (Capacity)' },
            design_dc: { type: 'number', label: 'Crafting DC / Wealth Score' },
            ...
            description: { type: 'textarea' },
            facilities: { type: 'multiselect', source: 'component', manageable: true, label: 'Installed Facilities (Modules)' },
            hardpoints: { type: 'multiselect', source: 'component', manageable: true, label: 'Installed Hardpoints (Mounts)' },
            internals: { type: 'multiselect', source: 'component', manageable: true, label: 'Core Internals (Generators)' },
            prerequisite: { type: 'multiselect', source: 'prerequisite', manageable: true },
            modifier: { type: 'multiselect', source: 'modifier', manageable: true },
            mechanic: { type: 'textarea' },
            note: { type: 'textarea' }
