...
export default function EconomatrixLootGeneratorModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl max-h-[90vh] bg-[#0d121c] border-2 border-amber-500/70 rounded-2xl shadow-[0_0_45px_rgba(245,158,11,0.3)] flex flex-col overflow-hidden text-slate-100 font-sans">
