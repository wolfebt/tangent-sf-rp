...
const SyncConflictModal = ({ isOpen, conflictData, onOverwrite, onPull, onCancel }) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-start justify-center bg-black/85 backdrop-blur-md p-4 pt-10 sm:pt-14 pb-12 overflow-y-auto select-none font-sans animate-fadeIn">
