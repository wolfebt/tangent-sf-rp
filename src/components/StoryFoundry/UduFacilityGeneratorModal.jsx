...
export default function UduFacilityGeneratorModal({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-start justify-center bg-black/80 backdrop-blur-md p-3 sm:p-6 pt-8 sm:pt-12 md:pt-14 pb-12 overflow-y-auto select-none font-sans animate-in fade-in duration-200">
      <div className="relative w-full max-w-4xl max-h-[85vh] sm:max-h-[88vh] bg-[#0c121b] border-2 border-amber-500/70 rounded-2xl shadow-[0_0_45px_rgba(245,158,11,0.3)] flex flex-col overflow-hidden text-slate-100 font-sans">
