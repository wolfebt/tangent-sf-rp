...
const MapLayersPanel = ({
  ...
  return (
    <div className="absolute top-4 right-4 z-30 w-64 bg-[#161b22]/90 backdrop-blur-md border border-[#0D5C63]/80 rounded-lg shadow-[0_0_15px_rgba(0,0,0,0.6)] p-3 flex flex-col gap-2 select-none">
      <div className="flex justify-between items-center pb-1.5 border-b border-[#0D5C63]/50 mb-1">
        <h3 className="sci-fi-title-text font-bold text-xs uppercase tracking-wider drop-shadow-[0_0_5px_rgba(34,211,238,0.4)] flex items-center gap-1.5">
          🥞 Layers
        </h3>
        <button 
