...
const MapKeyPanel = ({
  ...
  return (
    <div className="absolute bottom-4 left-4 z-30 w-80 bg-[#161b22]/95 backdrop-blur-md border border-[#0D5C63] rounded-lg shadow-[0_0_20px_rgba(0,0,0,0.8)] p-3 flex flex-col gap-2.5 select-none max-h-[480px]">
      {/* Header Tabs */}
      <div className="flex justify-between items-center pb-2 border-b border-[#0D5C63]/50">
        <div className="flex items-center gap-1 bg-[#0d1117] p-0.5 rounded border border-[#0D5C63]/60">
          <button
            onClick={() => setActiveTab('legend')}
            className={`px-2.5 py-1 text-[10px] font-bold uppercase rounded transition-all ${
              activeTab === 'legend'
                ? 'bg-cyan-950 text-[#22d3ee] border border-[#22d3ee]/60 shadow-[0_0_8px_rgba(34,211,238,0.3)]'
