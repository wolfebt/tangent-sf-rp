...
const MapToolsPanel = ({
  ...
  return (
    <>
      ...
      {showToolsPanel && (
        <div className="absolute top-4 left-4 z-30 w-44 bg-[#161b22]/90 backdrop-blur-md border border-[#0D5C63]/80 rounded-lg shadow-[0_0_15px_rgba(0,0,0,0.6)] p-3 flex flex-col gap-2 select-none">
