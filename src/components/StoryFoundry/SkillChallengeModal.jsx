...
const SkillChallengeModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 select-none animate-fadeIn">
      <div className="bg-[#121622] border border-emerald-500/70 rounded-xl p-5 w-full max-w-2xl shadow-[0_0_50px_rgba(16,185,129,0.3)] text-white flex flex-col gap-4 max-h-[90vh] overflow-hidden">
        {/* Header */}
