...
const MapMetadataPanel = ({
  ...
  return (
    <DraggablePanel id="metadata_panel" className="absolute top-4 right-16 z-30 hover:z-40 focus-within:z-40 w-72 bg-[#161b22]/95 backdrop-blur-md border border-[#0D5C63]/80 rounded-lg shadow-[0_0_20px_rgba(0,0,0,0.7)] p-3 flex flex-col gap-3 select-none text-slate-200">
      <div className="drag-handle cursor-grab active:cursor-grabbing flex justify-between items-center pb-2 border-b border-[#0D5C63]/50">
        <h3 className="sci-fi-title-text font-bold text-xs uppercase tracking-wider text-[#22d3ee] drop-shadow-[0_0_5px_rgba(34,211,238,0.4)] flex items-center gap-1.5 pointer-events-none">
