...
const ScenarioObjectivesModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/75 backdrop-blur-sm flex items-center justify-center p-4">
      <div className="bg-[#0f172a] border border-cyan-500/60 rounded-xl shadow-[0_0_30px_rgba(6,182,212,0.25)] w-full max-w-2xl overflow-hidden flex flex-col text-slate-200 font-sans animate-in fade-in zoom-in-95 duration-150">
        {/* Header */}
