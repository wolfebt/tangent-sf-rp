...
const ConditionManagerModal = ({
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-start justify-center bg-black/80 backdrop-blur-md p-3 sm:p-6 pt-8 sm:pt-12 md:pt-14 pb-12 overflow-y-auto select-none font-sans">
      <div className="bg-[#12161f] border border-cyan-500/50 rounded-xl p-5 w-full max-w-2xl shadow-[0_0_40px_rgba(6,182,212,0.25)] text-white flex flex-col gap-4 max-h-[85vh] sm:max-h-[88vh] overflow-hidden">
        {/* Header */}
