...
const MapCombatTracker = ({
  ...
  return (
    <DraggablePanel id="combat_tracker" className="absolute bottom-4 left-4 z-30 w-72 bg-[#161b22]/95 backdrop-blur-md border border-amber-500/60 rounded-lg shadow-[0_0_20px_rgba(245,158,11,0.25)] p-3 flex flex-col gap-2 font-sans select-none">
      {/* Header */}
