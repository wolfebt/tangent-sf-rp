...
export const OmnicortexCatalogView = ({
  ...
  // ⚡ Bolt: Defer search query state to prevent UI stutter during rapid typing on large lists
  // Expected Impact: Eliminates main thread blocking; search input remains 60fps responsive
