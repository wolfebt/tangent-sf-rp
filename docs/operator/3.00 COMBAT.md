...
*The attacker rolls 2d10, adds their relevant Skill Rank, Attribute modifier, and situational bonuses, and compares the total to the target's Defense. If the total exceeds the target's Defense (or meets/exceeds static CR 15 on unopposed checks), the attack hits. Remember: Defender wins all ties on opposed rolls.*  
*Upon a successful hit, the attacker then rolls their weapon's damage dice, adds any relevant damage modifiers, and subtracts the target's Damage Resist (DR) and CON modifier. The resulting number is the amount of damage the target takes.*  
...
Rolling dual 10s (natural 20) on 2d10 results in a critical hit, doubling the weapon's damage dice and treating the base attack score as 30. Conversely, rolling dual 1s (natural 2) results in a fumble, treating the base attack score as -10 and potentially causing additional negative consequences.
