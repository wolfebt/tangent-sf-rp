...
The combat system uses a d20 dice system that factors in character skills, abilities, and other modifiers. Combat actions are determined by Skill Rank, with higher Ranks unlocking additional actions per turn.  
**The Attack Roll:** d20 \+ Skill Rank \+ Attribute Mod \+ Situational Modifiers vs. Target Defense (DC).
...
Determined by a **Reflex Check** (d20 \+ Reflex Save \+ Agility Mod). High roll goes first. Modifiers may apply based on the situation (e.g., Ambush).
...
In the Tangent universe, vehicular combat is not a separate game; it is an escalation of the core d20 mechanics. Whether piloting a nimble hover-bike or commanding a gargantuan void-cruiser, the loop remains: **Action, Reaction, Consequence.**
...
* **Initiative:** Determined by the **Pilot**.  
  * *Formula:* d20 \+ Agility Mod \+ Alertness \+ Handling Modifier  
