...
# **OPERATOR RULES STRUCTURE**

* **1.00 INTRODUCTION & GLOSSARY**
* **1.01 CHARACTER CREATION** (150 BP Economy, Attributes, Check Base, Rest & Dying)
* **1.02 ARCHETYPES** (Pre-built & Modular Chassis)
* **1.03 SPECIES & LINEAGES** (Biological & Synthetic Heritages)
* **1.04 FACTIONS** (Allegiances, Agendas & Faction Traits)
* **1.05 ORIGINS** (Backgrounds, Cultural Upbringing & Traits)
* **1.06 OCCUPATIONS** (Careers, Core Skills & Professional Features)
* **1.07 SKILLS & SPECIALIZATIONS** (Master Skill Catalog & TN Thresholds)
* **1.08 FEATURES & FEATS** (General, Attribute & Special Talents)
* **1.09 HINDRANCES & FLAWS** (Character Flaws & CP Rebates)
* **1.10 MOVEMENT RULES & TACTICAL PACES** (Ground, Air, Aquatic & Special Locomotion)
* **1.11 EXPERIENCE & ADVANCEMENT** (Award Points, Story & Session Awards, Increment Rule & Downtime)
* **2.00 ECONOMATRIX & WEALTH** (Standard Economics, Crafting DC & Equipment)
* **3.00 COMBAT SYSTEM** (Tactical Rounds, Actions, Attack & Damage Resolution)
* **4.00 METAPHYSICS & DISCIPLINES** (The Six Disciplines, Attunement & Invocations)
...
| AP | Progression | **Award Points**. Experience points spent 1-for-1 like BP ($1\text{ AP} = 1\text{ BP}$). Subject to The Increment Rule (max +1 to any score per award). | 1 to ∞ (Standard: 1-3 AP/session) |
...
| Term | Domain | Definition | Range / Limit |
| :---- | :---- | :---- | :---- |
| Vitality | Integrity | Physical resilience, poise, and stamina. Absorbs non-lethal damage directly; excess spills to Health as lethal. | Base 30 + (5 per CP, max +5×STA). Recovers fast. Not modified by Willpower. |
| Health | Integrity | Structural integrity and core life force. Depleted directly by lethal damage or non-lethal spillover. | Base 30 + (5 per CP, max +5×STA). Recovers slow. Not modified by Fortitude. |
| Structure | Integrity | Total of Health + Vitality scores for Synthetics and constructs. | Combined pools (Health + Vitality). Immune to non-lethal damage. |
| DR | Defense | Damage Reduction. Stamina is natural DR automatically reducing penetrating damage, minimum 1 point. | Natural DR = Stamina score (min 1 pt penetrating); Armor DR 0 to 60+ |
